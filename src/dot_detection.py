...
#d1542_dots= [[d1542_center[0], d1542_center[0], d1542_center[0],  d1542_center[0]+ scale,  d1542_center[0]- scale ], [d1542_center[1]+scale,d1542_center[1]-scale,d1542_center[1],d1542_center[1],d1542_center[1]]]
d1542_dots = [0,0,0,0]	    
